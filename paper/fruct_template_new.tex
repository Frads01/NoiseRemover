...
%% When using BibTeX please uncomment the line below 
%% Do not forget to run bibtex to produce a proper bbl file.
\bibliography{FRUCTexample}

%% more examples are in IEEEexample.bib). 
% \bibliography{IEEEabrv, IEEEexample}

%% For using \begin{thebibliography} construction uncomment the line below or directly insert the bibliography text.
%\input{FRUCTexample.bbl}
